      ...
      <main className="flex-grow pt-32 pb-20 px-8 max-w-7xl mx-auto w-full">
        <header className="mb-16 text-center max-w-3xl mx-auto">
          <div className="flex items-center justify-center gap-4 mb-6">
            ...
            <h1 className="text-4xl md:text-6xl font-black text-primary tracking-tight">
              স্মৃতিসুধা: ফটো গ্যালারি
            </h1>
            <div className="h-1 bg-[#CEB888] w-12 rounded-full"></div>
          </div>
          <p className="text-muted leading-relaxed font-medium">
            হলি ক্রিসেন্ট স্কুলের সোনালী দিনগুলো এবং পুনর্মিলনী অনুষ্ঠানের বিশেষ
            মুহূর্তগুলো এখানে সংরক্ষিত রয়েছে।
          </p>
        </header>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mb-16">
          <div className="flex items-center gap-2 mr-4 text-primary opacity-40">
            <Filter size={18} />
            <span className="text-[10px] font-black uppercase tracking-widest text-[#1F3D2B]">
              Filter Memories
            </span>
          </div>
