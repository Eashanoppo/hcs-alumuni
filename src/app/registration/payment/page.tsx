...
import { CheckCircle2, CreditCard, Copy, AlertCircle, Phone, ArrowRight, Loader2 } from "lucide-react"
            ...
            <div className="bg-[#1F3D2B] rounded-4xl p-8 text-white shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <p className="text-xs font-black uppercase tracking-widest text-[#CEB888]">Reference Note</p>
                </div>
                <p className="text-sm leading-relaxed font-bold opacity-80">
                  পেমেন্ট করার সময় রেফারেন্সে আপনার <span className="text-white underline underline-offset-4 decoration-[#CEB888]">ইমেইল</span> অথবা <span className="text-white underline underline-offset-4 decoration-[#CEB888]">মোবাইল নম্বর</span> অবশ্যই লিখুন।
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-10">
            <div className="bg-white rounded-[3.5rem] shadow-premium border border-gray-100 p-10 md:p-14">
              ...
              <div className="bg-[#FAFAF7] rounded-[2.5rem] p-8 mb-12 border border-gray-100">
                <p className="text-[10px] font-black text-muted uppercase tracking-[0.3em] mb-6">Payment Instructions</p>
              ...
              <form onSubmit={handlePaymentSubmit} className="space-y-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    <label className="block text-[10px] font-black text-primary uppercase tracking-[0.2em] ml-1">আপনার নম্বর (Sender Number)</label>
                    <input 
                      required
                      type="tel"
                  ...
                  <div className="space-y-3">
                    <label className="block text-[10px] font-black text-primary uppercase tracking-[0.2em] ml-1">ট্রানজেকশন আইডি (TrxID)</label>
                    <input 
                      required
                      type="text"
...
export default function PaymentPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center pt-28"><Loader2 className="animate-spin text-primary" size={32} /></div>}>
      <PaymentForm />
    </Suspense>
  )
}
