      ...
      <main className="flex-grow pt-32 pb-24">
        <header className="max-w-7xl mx-auto px-8 mb-20">
          ...
          <p className="text-lg text-muted max-w-2xl leading-relaxed">
            আপনার যেকোনো জিজ্ঞাসা বা পরামর্শের জন্য আমরা সবসময় প্রস্তুত। নিচের
            ফরমটি পূরণ করুন অথবা আমাদের সরাসরি কল করুন।
          </p>
        </header>
        ...
        <section className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div className="space-y-12">
            ...
            <div className="bg-primary p-12 rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden">
              <div className="relative z-10">
                <h3 className="text-3xl font-black mb-6 text-accent">
                  জরুরি সহায়তা
                </h3>
              ...
              <MessageSquare
                className="absolute -right-12 -bottom-12 opacity-5 text-accent rotate-12"
                size={240}
              />
            </div>
          </div>
          ...
          <div className="bg-white p-10 md:p-14 rounded-[3rem] shadow-2xl border border-gray-100">
            <h3 className="text-3xl font-black text-primary mb-10 tracking-tight">
              সরাসরি মেসেজ পাঠান
            </h3>
            <form className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="text-xs font-bold text-muted uppercase tracking-widest ml-2">
                    আপনার নাম
                  </label>
                  <input
                    type="text"
                    className="w-full px-6 py-4 bg-background border-none rounded-2xl focus:ring-2 focus:ring-accent transition-all font-medium"
              ...
              <div className="space-y-2">
                ...
                <input
                  type="text"
                  className="w-full px-6 py-4 bg-background border-none rounded-2xl focus:ring-2 focus:ring-accent transition-all font-medium"
                  placeholder="রেজিস্ট্রেশন সংক্রান্ত জিজ্ঞাসা"
                />
              </div>
              <div className="space-y-2">
                <label className="text-xs font-bold text-muted uppercase tracking-widest ml-2">
                ...
                <textarea
                  rows={5}
                  className="w-full px-6 py-4 bg-background border-none rounded-2xl focus:ring-2 focus:ring-accent transition-all font-medium resize-none"
