        ...
        <div className="relative z-10 w-full max-w-lg">
          <div className="text-center mb-12">
            ...
            <p className="text-muted text-lg font-bold">
              Authorized Personnel Only • HCS Portal
            </p>
          </div>
          ...
          <div className="bg-white rounded-[3.5rem] shadow-premium border border-gray-100 p-10 md:p-14">
            ...
            <Link
              href="/"
              className="mt-10 text-center block text-sm font-black text-muted hover:text-primary transition-colors uppercase tracking-widest"
            >
              Back to Campus
            </Link>
          </div>
