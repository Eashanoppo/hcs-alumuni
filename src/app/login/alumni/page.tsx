...
export default function AlumniLogin() {
  ...
  return (
    <div className="min-h-screen flex flex-col pt-20">
      <Navbar />
      <main className="grow flex items-center justify-center px-4 py-16 bg-[#FAFAF7] relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-5xl flex flex-col items-center justify-center gap-12 lg:gap-16">
          <div className="w-full max-w-md bg-white rounded-3xl shadow-premium border border-gray-100 overflow-hidden">
