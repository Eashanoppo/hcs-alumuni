            ...
            <AnimatePresence>
              {isExpanded && (
                <motion.div
                  ...
                  transition={{ type: "spring", stiffness: 300, damping: 25 }}
                  className="absolute bottom-[70px] right-0 w-[calc(100vw-3rem)] sm:w-[360px] origin-bottom-right pointer-events-auto"
                >
                  <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-[#eee] min-w-75">
