...
import { LayoutDashboard, Users, CreditCard, LogOut, ChevronRight, Megaphone, Image as ImageIcon, Menu, X } from "lucide-react"
...
export default function AdminSidebar() {
  ...
  return (
    <>
      ...
      {/* ── Mobile top bar (< lg) ── */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-200 bg-[#1F3D2B] text-white flex items-center justify-between px-5 h-16 border-b border-white/10 shadow-lg">
      ...
      {/* ── Mobile drawer panel ── */}
      <div
        className={`lg:hidden fixed top-0 left-0 z-400 h-full w-72 bg-[#1F3D2B] text-white flex flex-col p-8 shadow-2xl transition-transform duration-300 ease-in-out ${open ? 'translate-x-0' : '-translate-x-full'}`}
      >
